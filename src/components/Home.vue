  ...
  <div class="main">
    ...
    <div class="vertical-nav" id="sidebar">
      ...
      <ul class="nav flex-column mb-0">
        <li class="nav-item">
          <a href="/adprofile" class="nav-link text-light font-bold">
            <b>
        ...
        <li class="nav-item">
          <a href="/adminyearlypayslip" class="nav-link text-light font-bold">
          <b>
             <span style="color:white">
              <i class="fa text-primary fa-fw"></i>
              Yearly payslip</span
      ...
      -->
        ...
        <li class="nav-item">
          <a href="/win" class="nav-link text-light font-bold">
          <b>  <span style="color:white">
              <i class="fa text-primary fa-fw"></i>
        ...
        <li class="nav-item">
          <a href="/wreport" class="nav-link text-light font-bold">
          <b> <span style="color: white">
              <i class="fa text-primary fa-fw"></i>
    ...
    <div class="main2">
      <div class="page-content p-5" id="content">
        ...
        <img id="chobi" src="../assets/home.jpg" />
