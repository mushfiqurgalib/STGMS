  ...
  <div class="bg">
    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        >
          <span class="login100-form-title">Wages Transaction </span>
...
.wrap-login100 {
  width: 960px;
  background: white; /* BOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX */
  border-radius: 10px;
  overflow: hidden;
  ...
  padding: 45px 100px 33px 95px; /* boxxxxxxxxxxxx sizeeeeeeeeeeeeeee */
}
