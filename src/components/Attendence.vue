    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-pic js-tilt" data-tilt>
          <img src="../assets/attendd.jpg" alt="IMG" />
        </div>
        ...
        >
          <span class="login100-form-title"> Attendence Dashboard </span>
...
.wrap-login100 {
  ...
  padding: 100px 130px 33px 95px; /* boxxxxxxxxxxxxxxxxx szeeeeeeeeeee */
}
